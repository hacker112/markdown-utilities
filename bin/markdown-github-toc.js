...
const cli = meow(`
    ...
    `, {
    description: 'Add Github compatible table of content to markdown (Replacing <!-- toc --> in source file)',
    flags: {
        maxdepth: {
            type: 'number',
            default: 6,
...
const destination = insert ? source : (cli.input[1] || source.replace(/\.md$/,'-toc.md'))
